...
public class ManagerService {
	...
	// 리스트
	public List<ProductVo> exeCateList(String category) {
		System.out.println("ManagerService.exeCateList()");

		List<ProductVo> pList = managerDao.selectCategory(category);
	...
	public String exeUpload(MultipartFile file, int no) {
		...
		// 파일저장 폴더
		String saveDir = "C:\\javastudy\\kiosk\\imgUpload";
